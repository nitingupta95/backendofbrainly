...
// Content Routes
app.get('/api/v1/content',auth, async (req, res: Response) => {
  try {
...
app.post('/api/v1/content', auth,async (req, res: Response) => {
  try {
...
// Route to Fetch Shared Brain Content
